...
public isolated client class Client {
    ...
    remote isolated function createA_InbDeliveryHeader(API_INBOUND_DELIVERY_SRV\.A_InbDeliveryHeaderType\-create payload, map<string|string[]> headers = {}) returns A_InbDeliveryHeaderType|error {
    ...
    # + return - Success 
    remote isolated function createAddSerialNumberToDeliveryItem(map<string|string[]> headers = {}, *CreateAddSerialNumberToDeliveryItemQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createConfirmPutawayAllItems(map<string|string[]> headers = {}, *CreateConfirmPutawayAllItemsQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createConfirmPutawayOneItem(map<string|string[]> headers = {}, *CreateConfirmPutawayOneItemQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createCreateBatchSplitItem(map<string|string[]> headers = {}, *CreateCreateBatchSplitItemQueries queries) returns CreatedDeliveryItem|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createDeleteAllSerialNumbersFromDeliveryItem(map<string|string[]> headers = {}, *CreateDeleteAllSerialNumbersFromDeliveryItemQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createDeleteSerialNumberFromDeliveryItem(map<string|string[]> headers = {}, *CreateDeleteSerialNumberFromDeliveryItemQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createPostGoodsReceipt(map<string|string[]> headers = {}, *CreatePostGoodsReceiptQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createPutawayAllItems(map<string|string[]> headers = {}, *CreatePutawayAllItemsQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createPutawayOneItem(map<string|string[]> headers = {}, *CreatePutawayOneItemQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createPutawayOneItemWithBaseQuantity(map<string|string[]> headers = {}, *CreatePutawayOneItemWithBaseQuantityQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createPutawayOneItemWithSalesQuantity(map<string|string[]> headers = {}, *CreatePutawayOneItemWithSalesQuantityQueries queries) returns Wrapper_7|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createReverseGoodsReceipt(map<string|string[]> headers = {}, *CreateReverseGoodsReceiptQueries queries) returns Wrapper_8|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createSetPutawayQuantityWithBaseQuantity(map<string|string[]> headers = {}, *CreateSetPutawayQuantityWithBaseQuantityQueries queries) returns Wrapper_7|error {
    ...
    remote isolated function getA_InbDeliveryDocFlow(string PrecedingDocument, string PrecedingDocumentItem, string SubsequentDocumentCategory, map<string|string[]> headers = {}, *GetA_InbDeliveryDocFlowQueries queries) returns A_InbDeliveryDocFlowType|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entity 
    remote isolated function getA_InbDeliveryHeader(string DeliveryDocument, map<string|string[]> headers = {}, *GetA_InbDeliveryHeaderQueries queries) returns A_InbDeliveryHeaderType|error {
        string resourcePath = string `/A_InbDeliveryHeader('${getEncodedUri(DeliveryDocument)}')`;
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entity 
    remote isolated function getA_InbDeliveryItem(string DeliveryDocument, string DeliveryDocumentItem, map<string|string[]> headers = {}, *GetA_InbDeliveryItemQueries queries) returns A_InbDeliveryItemType|error {
        string resourcePath = string `/A_InbDeliveryItem(DeliveryDocument='${getEncodedUri(DeliveryDocument)}',DeliveryDocumentItem='${getEncodedUri(DeliveryDocumentItem)}')`;
        map<Encoding> queryParamEncoding = {"$select": {style: FORM, explode: false}, "$expand": {style: FORM, explode: false}};
        resourcePath = resourcePath + check getPathForQueryParam(queries, queryParamEncoding);
        return self.clientEp->get(resourcePath, headers);
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entity 
    remote isolated function getAddressOfA_InbDeliveryPartner(string PartnerFunction, string SDDocument, map<string|string[]> headers = {}, *GetAddressOfA_InbDeliveryPartnerQueries queries) returns A_InbDeliveryAddressType|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entity 
    remote isolated function getSerialDeliveryItemOfA_InbDeliveryItem(string DeliveryDocument, string DeliveryDocumentItem, map<string|string[]> headers = {}, *GetSerialDeliveryItemOfA_InbDeliveryItemQueries queries) returns A_InbDeliverySerialNmbrType|error {
    ...
    remote isolated function listA_InbDeliveryHeaders(map<string|string[]> headers = {}, *ListA_InbDeliveryHeadersQueries queries) returns Wrapper|error {
        string resourcePath = string `/A_InbDeliveryHeader`;
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listA_InbDeliveryItems(map<string|string[]> headers = {}, *ListA_InbDeliveryItemsQueries queries) returns Wrapper_2|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listDeliveryDocumentItemTextsOfA_InbDeliveryItem(string DeliveryDocument, string DeliveryDocumentItem, map<string|string[]> headers = {}, *ListDeliveryDocumentItemTextsOfA_InbDeliveryItemQueries queries) returns Wrapper_5|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listDeliveryDocumentItemsOfA_InbDeliveryHeader(string DeliveryDocument, map<string|string[]> headers = {}, *ListDeliveryDocumentItemsOfA_InbDeliveryHeaderQueries queries) returns Wrapper_2|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listDeliveryDocumentPartnersOfA_InbDeliveryHeader(string DeliveryDocument, map<string|string[]> headers = {}, *ListDeliveryDocumentPartnersOfA_InbDeliveryHeaderQueries queries) returns Wrapper_3|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listDeliveryDocumentTextsOfA_InbDeliveryHeader(string DeliveryDocument, map<string|string[]> headers = {}, *ListDeliveryDocumentTextsOfA_InbDeliveryHeaderQueries queries) returns Wrapper_1|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listDocumentFlowsOfA_InbDeliveryItem(string DeliveryDocument, string DeliveryDocumentItem, map<string|string[]> headers = {}, *ListDocumentFlowsOfA_InbDeliveryItemQueries queries) returns Wrapper_4|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listMaintenanceItemObjectsOfA_InbDeliverySerialNmbr(string MaintenanceItemObjectList, map<string|string[]> headers = {}, *ListMaintenanceItemObjectsOfA_InbDeliverySerialNmbrQueries queries) returns Wrapper_6|error {
